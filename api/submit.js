        ...
        <div style="background:#f9f7f4;padding:20px 24px;border-radius:0 0 8px 8px;border:1px solid #e0dad1">
          ...
          <table style="width:100%;border-collapse:collapse;background:#fff;border-radius:8px;overflow:hidden;border:1px solid #e0dad1">
            ...
            <tbody>
              ...
              <tr style="border-top:2px solid #1C5F6E"><td style="padding:10px 14px;font-size:14px;font-weight:700">TOTAL</td><td style="padding:10px 14px;text-align:center;font-size:15px;font-weight:700">${total}/75</td><td style="padding:10px 14px;text-align:center">-</td></tr>
            </tbody>
          </table>
          <p style="font-size:11px;color:#aaa;margin-top:20px;line-height:1.6">PDF completo com todas as respostas em anexo.</p>
        </div>
      </div>`;

    const payload = {
      from: 'SNAP-IV Emanah <noreply@bomfuturo.com.br>',
      to: ['dani_lbc@hotmail.com', 'jean_toya@hotmail.com', 'grupobomfuturo.mt@gmail.com'],
