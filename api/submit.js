      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="background:#f9f7f4;padding:20px 24px;border-radius:0 0 8px 8px;border:1px solid #e0dad1">
          ...
          <table style="width:100%;border-collapse:collapse;background:#fff;border-radius:8px;overflow:hidden;border:1px solid #e0dad1">
            ...
            <tbody>
              <tr style="background:#f0f8fa">
                <td style="padding:9px 14px;font-size:13px;font-weight:600">Desatenção</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${desatencao.score}/27</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${desatencao.pos}/9</td>
              </tr>
              <tr>
                <td style="padding:9px 14px;font-size:13px;font-weight:600">Hiperatividade / Impuls.</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${hiperatividade.score}/27</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${hiperatividade.pos}/9</td>
              </tr>
              <tr style="background:#f0f8fa">
                <td style="padding:9px 14px;font-size:13px;font-weight:600">Sint. Opositivos</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${opositivos.score}/21</td>
                <td style="padding:9px 14px;text-align:center;font-size:13px">${opositivos.pos}/7</td>
              </tr>
              <tr style="background:#1C5F6E22;border-top:2px solid #1C5F6E">
                <td style="padding:10px 14px;font-size:14px;font-weight:700">TOTAL</td>
                <td style="padding:10px 14px;text-align:center;font-size:15px;font-weight:700">${total}/75</td>
          ...
          <p style="font-size:11px;color:#aaa;margin-top:20px;line-height:1.6">
            📎 O PDF completo com todas as respostas está em anexo.<br>
            Este instrumento auxilia no rastreio mas não substitui avaliação clínica completa.
          </p>
        </div>
      </div>`;
